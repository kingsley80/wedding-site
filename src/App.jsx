  ...
  return (
    <>
        ...
        <div className="container px-4 mx-auto relative text-lg">
          <div className="flex justify-between items-center">
            <div className="flex items-center flex-shrink-0">
              <h1 className="text-2xl tracking-light font-bold">bRIDAL</h1>
            </div>
            <ul className="hidden lg:flex ml-14 space-x-8 font-medium">
          ...
          {mobileDrawerOpen && (
            <div className="fixed right-0 z-20 bg-neutral-900 w-full text-white p-12 flex flex-col justify-center items-center lg:hidden">
              <ul>
                {navItems.map((item, index) => (
      ...
      <figure class="max-w-screen-md mx-auto text-center mt-5">
        <h1 className="text-4xl mt-9">WHAT WE DO</h1>
        <p class="text-2xl mt-7 text-gray-900 dark:text-white">
          ...
          <div class="lg:-mx-6 lg:flex lg:items-center">
            <div class="lg:w-1/2 lg:px-6 lg:mt-0">
              <h1 class="text-2xl font-semibold text-gray-800 dark:text-white lg:text-3xl lg:w-96">
                We deliver the best event experience
              </h1>
              ...
              <p class="max-w-lg mt-6 text-gray-500 dark:text-gray-400 ">
                ...
                culpa aperiam dolorum, obcaecati corrupti aspernatur a. Lorem
                ipsum dolor sit amet, consectetur adipisicing elit. Tempore
                quibusdam ducimus libero ad tempora doloribus expedita laborum
                saepe voluptas perferendis delectus assumenda rerum, culpa
                aperiam dolorum, obcaecati corrupti aspernatur a.
              </p>
            </div>

            <video autoPlay loop muted id="video">
              <source class="" src={W3} type="video/mp4" />
            </video>
          </div>
        </div>
      </section>
        ...
        <div class="container px-6 py-10 mx-auto">
          <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
              ...
              <div class="md:flex md:items-start md:-mx-4 mr-8">
                <div class="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p class="mt-3 text-gray-500 dark:text-gray-300">
                    ...
                    doloribus voluptatum eveniet Lorem ipsum dolor sit amet
                    consectetur adipisicing elit. Quam ea laudantium, nobis
                    fugit incidunt iste veniam? Quis quibusdam amet dignissimos
                    optio corporis velit, sint explicabo ipsum natus, non odio.
                    Numquam? consectetur adipisicing elit. Quam ea laudantium,
                    nobis fugit incidunt iste veniam? Quis quibusdam amet
                    dignissimos optio corporis velit, sint explicabo ipsum
                    natus, non odio. Numquam?
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Card gallery */}
      <p class="text-2xl text-center text-gray-900 dark:text-white mt-9">
        <span className="text-4xl mb-4">OUR PREVIOUS PROJECTS</span> <br />
      </p>

      <div class="container px-6 py-12 mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
          <img class="h-96 w-96 rounded-lg" src={u1} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u2} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u3} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u4} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u5} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u6} alt="" />
        </div>
        <div>
          <img class="h-96 w-96 rounded-lg" src={u3} alt="" />
        </div>
      ...
      <div class="text-center">
        <button className="w-2/4 text-center bg-black text-white h-[50px]">
          VIEW MORE
        </button>
      </div>

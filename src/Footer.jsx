...
const Footer = () => {
  return (
    ...
    //       <a href="#">
    //         <h1 className="text-2xl">bRidal.com</h1>
    //       </a>
    ...
    <footer class="bg-white dark:bg-gray-900">
      <div class="container px-6 py-12 mx-auto">
        <hr class="my-6 border-lime-900 md:my-8 dark:border-gray-100" />
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
          <div class="sm:col-span-2">
            <h1 class="max-w-lg text-xl font-semibold text-uppercase tracking-tight text-gray-800 xl:text-2xl dark:text-white">
          ...
          <div>
            ...
            <div class="flex flex-col items-start mt-5 space-y-2">
              <p>Phone: +4412345678</p>
              <p>Email: bridals@demomail.com</p>
              <p>Instagram: bridal120</p>
          ...
          <div>
            ...
            <div class="flex flex-col items-start mt-5 space-y-2">
              <p>No. 287B Freeway Plaza,</p>
              <p>Ahmadu Bello, Wuse Zone 5</p>
            ...
            {/* <div class="flex flex-col items-start mt-5 space-y-2">
              <a
                ...
                class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
              >
                No. 287B Freeway Plaza,
              </a>
              <a
                href="#"
                class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
              >
                Ahmadu Bello, Wuse Zone 5
              </a>
              <a
                href="#"
                class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
        ...
        <hr class="my-6 border-gray-200 md:my-8 dark:border-gray-100" />
